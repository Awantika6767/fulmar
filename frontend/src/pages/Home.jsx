    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#1e3a8a]/95 via-slate-900/90 to-[#1e40af]/95 z-10 animate-gradient"></div>
          <img 
        ...
        <div className="relative z-20 max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in-up">
            ...
            <span className="bg-gradient-to-r from-[#60a5fa] to-[#93c5fd] bg-clip-text text-transparent animate-gradient-text">
              Engine Specialists
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8 animate-fade-in-up animation-delay-200">
            Deployed globally for planned maintenance, performance recovery, and catastrophic engine casualty response
          </p>
          <p className="text-lg text-[#93c5fd] mb-12 animate-fade-in-up animation-delay-400">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Card key={index} className="bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all duration-300 animate-fade-in-up hover:scale-105 hover:shadow-2xl" style={{ animationDelay: `${800 + index * 100}ms` }}>
                <CardContent className="p-4 flex flex-col items-center text-center">
                  <div className="text-[#93c5fd] mb-2 animate-float" style={{ animationDelay: `${index * 200}ms` }}>{item.icon}</div>
      ...
      <section id="services" data-animate className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center mb-16 transition-all duration-1000 ${visibleSections['services'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Our Core Services
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-[#1e3a8a] to-[#3b82f6] mx-auto mb-6 animate-width-expand"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {mainServices.map((service, index) => (
              <Card 
                key={index} 
                className={`group overflow-hidden hover:shadow-2xl transition-all duration-500 border-2 border-gray-100 hover:border-[#3b82f6] hover:-translate-y-2 ${visibleSections['services'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
      ...
      <section id="mechanical" data-animate className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className={`transition-all duration-1000 ${visibleSections['mechanical'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Mechanical Repair & Engine Services
              </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-[#1e3a8a] to-[#3b82f6] mb-6 animate-width-expand"></div>
            ...
            <div className={`relative transition-all duration-1000 ${visibleSections['mechanical'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
              <div className="absolute -inset-4 bg-gradient-to-r from-[#1e3a8a]/20 to-[#3b82f6]/20 rounded-2xl blur-xl animate-pulse-slow"></div>
              <img 
                src="https://images.unsplash.com/photo-1667316337036-5b82f7d6535c" 
                alt="Engine Services"
                className="relative rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105"
              />
            </div>
          </div>
      ...
      {/* Why Choose Fulmar */}
      <section id="why-choose" data-animate className="py-20 px-4 bg-gradient-to-br from-[#1e3a8a] via-slate-800 to-[#1e40af] text-white relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 w-72 h-72 bg-[#60a5fa]/10 rounded-full blur-3xl animate-blob"></div>
          <div className="absolute top-40 right-10 w-96 h-96 bg-[#93c5fd]/10 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-10 left-1/3 w-80 h-80 bg-[#3b82f6]/10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
        </div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className={`text-center mb-16 transition-all duration-1000 ${visibleSections['why-choose'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl font-bold mb-4">Why Choose Fulmar</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-[#60a5fa] to-[#93c5fd] mx-auto mb-6 animate-width-expand"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card 
                key={index} 
                className={`bg-white/10 backdrop-blur-md border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-105 hover:shadow-2xl ${visibleSections['why-choose'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
